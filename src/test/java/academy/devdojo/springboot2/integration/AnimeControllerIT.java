...
class AnimeControllerIT {
	...
	private static final DevDojoUser USER = DevDojoUser.builder()
			...
			.password("{bcrypt}$2a$10$QX7JJZ3AbVTqzb0SyaZhYuJ.nvtU9p36flxVwp1V0kQKlDMcS87RW")
			.username("devdojo")
	...
	private static final DevDojoUser ADMIN = DevDojoUser.builder()
			...
			.password("{bcrypt}$2a$10$ETz6pjIECIP9fsbGChEVtumu0Sjv2rtg5vh8XTHPJyevcmmMPishi")
			.username("israelferreira")
	...
	static class Config {
		...
		public TestRestTemplate testRestTemplateRoleAdminCreator(@Value("${local.server.port}") int port) {
			RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder()
					.rootUri("http://localhost:"+port)
					.basicAuthentication("israelferreira", "springboot");
			return new TestRestTemplate(restTemplateBuilder);
		}
	}
